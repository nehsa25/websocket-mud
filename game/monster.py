...
from game.interfaces.player import PlayerInterface
from helper.mob import MOBHelper
from class_types.attributes_type import AttributesType
from class_types.statuses_type import StatusesType
from utilities.log_telemetry import LogTelemetryUtility


class Monster(PlayerInterface, MOBHelper):
    eye_color = None
    hair_color = None
    hair_length = None
