...
class Princess(Mob):
    ...
    interests = [f"I live in the fantasy world of {Utility.WORLD_NAME}, in the town Smee", "I can break the fourth wall and talk about game of thrones"]
    type = Utility.Npcs.PRINCESS
