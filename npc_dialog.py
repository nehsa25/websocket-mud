...
class NpcDialog:
    ...
    async def intelligize_npc(self, npc, room_description, current_interests):
        ...
        You are in the room {room_description} and the following is happening: {current_interests}.  
        Pick only one thing to reply to and it shoud be something that is in your general intereste if possible. Reply as if you were {npc.name}."""
