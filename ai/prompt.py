class PromptSettings:
    ...
    room_tone = {
        "style": ["Expressionist", "line art drawing", "fantasy", "early 6th century AD", "two-tone color"],
        "description": "<description of room is here>",
        "negative_prompt": ["photo", "realistic" "bad anatomy", "bad proportions", "bad perspective", "bad lighting", "bad color", "bad composition"]
    }
    ...
    monster_tone = {
        "style": ["Expressionist", "line art drawing", "fantasy", "early 6th century AD", "two-tone color", "sinister"],
