...
from core.enums.monsters import MonsterEnum
...
class WorldState:
    ...
    def __init__(self) -> None:
        ...
        self.weather.weather_type = WeatherTypeEnum.SUN
        self.weather.current_season = WeatherSeasonEnum.SUMMER
        self.weather.weather_strength = WeatherStrengthEnum.LIGHT
    ...
    async def setup_world_events(self):
        ...
        if len(self.monsters) == 0:
            self.monsters = deepcopy(MonsterEnum)
    ...
    async def change_weather(self):
        ...
        while True:
            ...
            self.weather.weather_type = random.choice(list(WeatherTypeEnum))
    ...
    async def change_season(self):
        ...
        while True:
            ...
            self.weather.current_season = random.choice(list(WeatherSeasonEnum))
    ...
    async def day_or_night(self):
        ...
        while True:
            ...
            if self.weather.dayornight == TimeOfDayEnum.NOON:
                self.weather.dayornight = TimeOfDayEnum.NIGHT
            else:
                self.weather.dayornight = TimeOfDayEnum.NOON
