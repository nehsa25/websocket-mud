...
#             self.logger.debug("Initializing Environments.Rooms() class")
...
#                 logger=self.logger,
#             )
#             self.logger.debug(f"generated room: {room}")
#             return room
...
#     def __init__(self):
#         self.logger = LogTelemetryUtility.get_logger(__name__)
#         self.logger.debug("Initializing Environments() class")
...
#                         "id": self.townsmee.sunroad_south4,
#                     },
#                     {"direction": self.dirs.south, "id": self.townsmee.outer_south5},
#                     {
#                         "direction": self.dirs.east,
...
#                     {
#                         "direction": self.dirs.east,
#                         "id": self.university.university_courtyard,
#                     },
#                 ]
#             ),
...
#                     {
#                         "direction": self.dirs.northeast,
#                         "id": self.university.university_garden,
#                     },
#                     {
#                         "direction": self.dirs.west,
#                         "id": self.university.university_entry,
...
#                     {
#                         "direction": self.dirs.north,
#                         "id": self.university.university_scriptorium,
#                     },
#                     {
#                         "direction": self.dirs.east,
#                         "id": self.university.university_dormitory,
#                     },
#                     {
#                         "direction": self.dirs.south,
#                         "id": self.university.university_refectory,
#                     },
#                     {
#                         "direction": self.dirs.southwest,
#                         "id": self.university.university_observatory,
#                     },
#                     {
#                         "direction": self.dirs.northwest,
#                         "id": self.university.university_mirrology,
#                     },
#                 ]
#             ),
...
#         # add in npcs
#         self.logger.info(
#             f"The world has {len(self.rooms)} rooms",
...
#         self.logger.debug(f"enter, message: {message}", self.townsmee.logger)
