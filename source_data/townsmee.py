...
class TownSmee:
    ...
    def __init__(self):
        ...
        self.logger.debug("Initializing TownSmee() class")
        ...
        self.townsquare = Room(
            ...
            monsters=[],
            npc_types=[Npcs.GUARD, Npcs.GUARD],
        ...
        self.inn = Room(
            ...
            npc_types=[Npcs.INNKEEPER, Npcs.PRINCESS, Npcs.MAXIMUS],
            environment=self.type,
        )
        self.sheriff = Room(
        ...
        self.market = Room(
            ...
            npc_types=[Npcs.MERCHANT, Npcs.THIEF],
            environment=self.type,
        )
        self.armoury = Room(
            ...
            npc_types=[Npcs.ARMORER],
            environment=self.type,
        )
        self.moonroad_west1 = Room(
            name=f"{self.name} - Moon Road (West)---1",
            inside=False,
            description="You are on one of the main thoroughfare of {WorldSettings.WORLD_NAME} running East and West directions. The street is broad, allowing for two wagons to pass each other.",
            environment=self.type,
        )
        ...
        self.sunroad_north1 = Room(
            ...
            inside=False,
            description="You are on the main thoroughfare of {WorldSettings.WORLD_NAME} running North and South directions. The street is broad, allowing for two wagons to pass each other.",
            environment=self.type,
        )
        ...
        self.gallows_east1 = Room(
            ...
            inside=False,
            description="The road is more an alley than main thoroughfare. The road is narrow and the buildings are close together. Trash litters each wall and there's a sweet rot in the air, nearly visible to the eye.",
            npc_types=[Npcs.GUARD, Npcs.GUARD],
            environment=self.type,
        )
        ...
        self.gallows = Room(
            ...
            inside=False,
            npc_types=[Npcs.GUARD, Npcs.GUARD],
            description="The road widens into a large gathering area. Sets of gallow line the road. A sign reads 'Next service in 3 days'. Admission is free but donations are accepted.",
            environment=self.type,
        )
        self.lower_quarter = Room(
            name=f"{self.name} - The Lower Quarter",
            inside=False,
            description="A gate with two guards stands before you. Each guard casually leans against halberds taller than they are. The gate is open and the guards are pleasantly chatting with each other whilst a long line of weary towns folk await admission into the city. A sign reads “1 copper entrance free. No exceptions.”",
            environment=self.type,
        )
        self.mindroad_nw1 = Room(
            name=f"{self.name} - Mind Road (Northwest)---1",
            inside=False,
            description="Mind road, also known as Scholar's Avenue, is a narrow, gravel road that runs northwest to southeast in Smee, the road extends far to the southeast at the University of Smee.",
            environment=self.type,
        )
        self.mindroad_se1 = Room(
            name=f"{self.name} - Mind Road (SouthEast)---1",
            inside=False,
            description="Mind road, also known as Scholar's Avenue, is a narrow, gravel road that runs northwest, past the town square, to the University of Smee to the southeast.",
            environment=self.type,
        )
        self.talentroad_ne1 = Room(
            name=f"{self.name} - Talent Road (NorthEast)---1",
            inside=False,
            description="Talent road is a cobblestoned street with an inclined elevation to the south.  This road has some of the finer merchants, inns, and shops in the town.  The street is lined with trees and the buildings are well kept.",
            environment=self.type,
        )
        ...
        self.mindroad_bridge = Room(
            ...
            inside=False,
            description="A large bridge spans a fast-flowing river.  The bridge is made from a glossy dark, almost black wood. Despite its apparently fragileness, the wood is extremely hard and no amount of weight has been found to cause the bridge to move.",
            environment=self.type,
        )
        ...
        self.rooftop_townsquare = Room(
            ...
            inside=False,
            description="You are on the rooftop above the town square. The rooftop feels secure with dark, sturdy wooden shingles. You can see the entire town from here and see paths to other rooftops. The town square is bustling with activity below.",
            environment=self.type,
        )
        self.rooftop_west1 = Room(
            name=f"{self.name} - Rooftop (West)---1",
            inside=False,
            description="The rooftop feels secure with dark, sturdy wooden shingles. You are on the rooftop overlooking the entrance to armoury below. You may be able to get down from here but will unikely be able to get back up here.",
            environment=self.type,
        )
        self.rooftop_west2 = Room(
            name=f"{self.name} - Rooftop (West)---2",
            inside=False,
            description="The rooftop feels secure with dark, sturdy wooden shingles. You are on the rooftop overlooking the entrance to inn below. You may be able to get down from here but will unikely be able to get back up here.",
            environment=self.type,
        )
        self.outer_west1 = Room(
            name=f"{self.name} - Outer wall (Inside West)---1",
            inside=False,
            description="You are at the western edge of Town Smee, just inside the outer wall. A large, cobbled road runs along the entire outer wall of town, 9 meters. The wall rises 7 meters high of young green timber. It's painted fresh with glossy brown paint on the inside.",
            environment=self.type,
        )
        ...
        self.outer_south1 = Room(
            ...
            inside=False,
            description="You are at the southern edge of Town Smee, just inside the outer wall. A large, cobbled road runs along the entire outer wall of town, 9 meters. The wall rises 7 meters high of young green timber. It's painted fresh with glossy brown paint on the inside.",
            environment=self.type,
        )
        ...
        self.outer_east1 = Room(
            ...
            inside=False,
            description="You are at the eastern edge of Town Smee, just inside the outer wall. A large, cobbled road runs along the entire outer wall of town, 9 meters. The wall rises 7 meters high of young green timber. It's painted fresh with glossy brown paint on the inside.",
            environment=self.type,
        )
        ...
        self.outer_north1 = Room(
            ...
            inside=False,
            description="You are at the norther edge of Town Smee, just inside the outer wall. A large, cobbled road runs along the entire outer wall of town, 9 meters. The wall rises 7 meters high of young green timber. It's painted fresh with glossy brown paint on the inside.",
            environment=self.type,
        )
